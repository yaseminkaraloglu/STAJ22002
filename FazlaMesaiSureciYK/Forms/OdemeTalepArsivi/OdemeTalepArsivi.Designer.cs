...
namespace FazlaMesaiSureciYK.Forms {
    ...
    public partial class OdemeTalepArsivi : Form<E_FazlaMesaiSureciYK_OdemeTalepArsiviEntity> {

        // properties
        Section Section1 { get; set; }
Column Column1 { get; set; }
DataGrid dgOdemeTalepArsivi { get; set; }


        // constructor
        public OdemeTalepArsivi(FormHttpParameters httpParameters, IContext context)
...
{ "tr-TR", "OdemeTalepArsivi" },
{ "en-US", "OdemeTalepArsivi" },
{ "ru-RU", "OdemeTalepArsivi" },
{ "az-Latn-AZ", "OdemeTalepArsivi" },
};
Name = "OdemeTalepArsivi";
FormId = "8dd59ed1-3156-43d1-8101-ed8f023f6c0f";
FormType = FormType.Standard;
ServerEvents = new List<EventItem> {
new EventItem {
Name = "OnToolbarButtonClicked",
MethodName = "dgOdemeTalepArsivi_OnToolbarButtonClick",
Async = null
},
};
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Ödeme Talep Arşivi" },{ "en-US", "OdemeTalepArsivi" },{ "ru-RU", "OdemeTalepArsivi" },{ "az-Latn-AZ", "OdemeTalepArsivi" },}){
...
BaseComponent default_odemetaleparsiviComponent = new BaseComponent {
Id = "OdemeTalepArsivi",
Type = "Form",
ParentId = "",
...
AddToViewItems("default", default_odemetaleparsiviComponent);

Section1 = new Section {
ControlId = "52e565ed-7f9e-42e4-ab01-d74aa71c88a2",
Name = "Section1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Column1 = new Column {
ControlId = "5e7fb652-3268-4430-9e68-1ce50781a838",
Name = "Column1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
dgOdemeTalepArsivi = new DataGrid {
ControlId = "c7deac1a-cc61-49d0-9e83-b85409199927",
Name = "dgOdemeTalepArsivi",
ServerEvents = new List<EventItem> {
new EventItem {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "en-US", "OdemeTalepArsivi_Grid" },{ "tr-TR", "Ödeme Talep Arşivi" },{ "az-Latn-AZ", "OdemeTalepArsivi_Grid" },{ "ru-RU", "OdemeTalepArsivi_Grid" },{ "zh-Hant-TW", "OdemeTalepArsivi_Grid" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
EditType = ColumnEditType.TimePicker,
EditingEnabled = true,
ShowEditorAlways = false,
Filtering = new DataGridColumnFilteringOptions {
Enabled = false,
...
Value = "",
Text = "",
EntityPath = "ML.cbMesaiNedeni",
ReadOnly = false,
Required = false,
MaxLength = 50
},
DbType = new ColumnDbType() {
ColumnName = "cbMesaiNedeni",
Type = "string"
},
FormatType = new ColumnFormatType {
Type = "label",
...
Value = "",
Text = "",
EntityPath = "ML.UNIQUEID_",
ReadOnly = false,
Required = false,
MaxLength = 50
},
DbType = new ColumnDbType() {
ColumnName = "UNIQUEID_",
Type = "string"
},
FormatType = new ColumnFormatType {
Type = "label",
...
new NumberBox {
Visible = true,
EntityPath = "documentId_",
ReadOnly = false,
Required = false,
},
DbType = new ColumnDbType() {
ColumnName = "documentId_",
Type = "decimal"
},
FormatType = new ColumnFormatType {
Type = "label",
...
Controls.Add(dgOdemeTalepArsivi);

BaseComponent default_dgodemetaleparsiviComponent = new BaseComponent {
Id = "dgOdemeTalepArsivi",
Type = "DataGrid",
ParentId = "Column1",
DesignerProps = new DesignerProps {
AllowAutoClear = true,
...
Properties = dgOdemeTalepArsivi,
ViewProperties = "",
};

AddToViewItems("default", default_dgodemetaleparsiviComponent);
...
ToolbarButtonClicked += dgOdemeTalepArsivi_OnToolbarButtonClick;

dgOdemeTalepArsivi.ToolbarButtonClick += dgOdemeTalepArsivi_OnToolbarButtonClick;

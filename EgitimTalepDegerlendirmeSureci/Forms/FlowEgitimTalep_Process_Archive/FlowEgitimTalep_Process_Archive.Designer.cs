...
namespace EgitimTalepDegerlendirmeSureci.Forms {
    ...
    public partial class FlowEgitimTalep_Process_Archive : Form<E_EgitimTalepDegerlendirmeSureci_FlowEgitimTalep_Process_ArchiveEntity> {

        // properties
        Section Section1 { get; set; }
Column Column1 { get; set; }
DataGrid FlowEgitimTalep_Process_Archive_Grid { get; set; }


        // constructor
        public FlowEgitimTalep_Process_Archive(FormHttpParameters httpParameters, IContext context)
...
{ "tr-TR", "FlowEgitimTalep_Process_Archive" },
{ "en-US", "FlowEgitimTalep_Process_Archive" },
{ "ru-RU", "FlowEgitimTalep_Process_Archive" },
{ "az-Latn-AZ", "FlowEgitimTalep_Process_Archive" },
};
Name = "FlowEgitimTalep_Process_Archive";
FormId = "4a4c843d-8555-480f-b06e-a9ff60832a7c";
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "FlowEgitimTalep_Process_Archive" },{ "en-US", "FlowEgitimTalep_Process_Archive" },{ "ru-RU", "FlowEgitimTalep_Process_Archive" },{ "az-Latn-AZ", "FlowEgitimTalep_Process_Archive" },}){
...
BaseComponent default_flowegitimtalep_process_archiveComponent = new BaseComponent {
Id = "FlowEgitimTalep_Process_Archive",
Type = "Form",
ParentId = "",
...
AddToViewItems("default", default_flowegitimtalep_process_archiveComponent);

Section1 = new Section {
ControlId = "d2e8e669-b0ab-4c85-96ae-2f151b569d41",
Name = "Section1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Id = "Section1",
Type = "Section",
ParentId = "FlowEgitimTalep_Process_Archive",
DesignerProps = new DesignerProps {
AllowAutoClear = true,
Layout = new ContainerLayout {
Width = null,
...
Column1 = new Column {
ControlId = "33f3e8d0-4711-4ed0-bcbc-c75d564b4a1c",
Name = "Column1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Items = new List<string> {
"FlowEgitimTalep_Process_Archive_Grid",
},
Properties = Column1,
ViewProperties = "",
};
...
FlowEgitimTalep_Process_Archive_Grid = new DataGrid {
ControlId = "99c564cd-6d0f-4f23-95b2-eb2578419898",
Name = "FlowEgitimTalep_Process_Archive_Grid",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
},
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "en-US", "FlowEgitimTalep_Process_Archive_Grid" },{ "tr-TR", "FlowEgitimTalep_Process_Archive_Grid" },{ "az-Latn-AZ", "FlowEgitimTalep_Process_Archive_Grid" },{ "ru-RU", "FlowEgitimTalep_Process_Archive_Grid" },{ "zh-Hant-TW", "FlowEgitimTalep_Process_Archive_Grid" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Required = false,
Indexable = false,
DisplayType = DataGridDisplayType.AutoFill,
...
Value = "",
Text = "",
EntityPath = "ML.ProcessCreator",
ReadOnly = false,
Required = false,
MaxLength = 500
},
DbType = new ColumnDbType() {
ColumnName = "ProcessCreator",
Type = "string"
},
FormatType = new ColumnFormatType {
Type = "label",
...
new NumberBox {
Visible = true,
EntityPath = "ProcessStatusNo",
ReadOnly = false,
Required = false,
},
DbType = new ColumnDbType() {
ColumnName = "ProcessStatusNo",
Type = "decimal"
},
FormatType = new ColumnFormatType {
Type = "label",
...
new NumberBox {
Visible = true,
EntityPath = "PackageVersion",
ReadOnly = false,
Required = false,
},
DbType = new ColumnDbType() {
ColumnName = "PackageVersion",
Type = "decimal"
},
FormatType = new ColumnFormatType {
Type = "label",
...
Value = "",
Text = "",
EntityPath = "ML.cbxEigitimAdi",
ReadOnly = false,
Required = false,
MaxLength = 500
},
DbType = new ColumnDbType() {
ColumnName = "cbxEigitimAdi",
Type = "string"
},
FormatType = new ColumnFormatType {
Type = "label",
...
ResizingMode = DataGridResizingMode.NextColumn,
},
...
Controls.Add(FlowEgitimTalep_Process_Archive_Grid);

BaseComponent default_flowegitimtalep_process_archive_gridComponent = new BaseComponent {
Id = "FlowEgitimTalep_Process_Archive_Grid",
Type = "DataGrid",
ParentId = "Column1",
DesignerProps = new DesignerProps {
AllowAutoClear = true,
...
Properties = FlowEgitimTalep_Process_Archive_Grid,
ViewProperties = "",
};

AddToViewItems("default", default_flowegitimtalep_process_archive_gridComponent);

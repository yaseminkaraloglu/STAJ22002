...
namespace EgitimTalepDegerlendirmeSureci
{
    public class Startup
    {
        ...
        app.UseScheduler((o) => o.Id = SchedulerHelper.GetDefaultSchedulerName("EgitimTalepDegerlendirmeSureci"));
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"asset")),
            RequestPath = new PathString("/apps/EgitimTalepDegerlendirmeSureci/latest/asset")
            });
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"dist")),
            RequestPath = new PathString("/apps/EgitimTalepDegerlendirmeSureci/latest/dist")
            });
            ...
            // app.UseSwaggerUI(c =>
            // {
        //     c.SwaggerEndpoint("v1/swagger.json", "Bimser.Synergy.EgitimTalepDegerlendirmeSureci.API.Swagger v1");
